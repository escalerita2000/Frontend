...
export function MyAccountPage() {
  ...
  const labelStyle = {
    ...
    fontWeight:700, letterSpacing:".16em", textTransform:"uppercase", color:C.gray,
  }
  const valueStyle = {
    fontFamily:"'Outfit',sans-serif", fontSize: isMobile ? ".82rem" : ".92rem",
  ...
  return (
    <div style={{
      ...
      background:C.greenMid, overflowY:"auto",
      display:"flex", alignItems:"flex-start", justifyContent:"center",
      padding: isMobile ? "24px 12px 80px" : "48px 24px",
    }}>
      <div style={{
        width:"100%", maxWidth:520,
        background:C.dark, borderRadius:14,
        border:`1px solid ${C.border}`,
        padding: isMobile ? "24px 16px 20px" : "36px 32px 28px",
        display:"flex", flexDirection:"column", gap: isMobile ? 16 : 24,
      }}>
        <h2 style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:"1.6rem",letterSpacing:".1em",color:C.white,margin:0}}>
          Mi cuenta
        </h2>

        <div style={{display:"flex",alignItems:"center",gap:14}}>
          {adminInfo.foto ? (
            <img src={adminInfo.foto} alt="avatar"
              style={{width: isMobile ? 56 : 72, height: isMobile ? 56 : 72,borderRadius:"50%",objectFit:"cover",border:`2px solid ${C.green}`,flexShrink:0}}
            />
          ) : (
            <div style={{
              ...
              display:"flex", alignItems:"center", justifyContent:"center",
              fontFamily:"'Bebas Neue',sans-serif", fontSize: isMobile ? "1.3rem" : "1.6rem",
          ...
          <div style={{minWidth:0}}>
            <p style={{fontFamily:"'Bebas Neue',sans-serif",fontSize: isMobile ? "1.1rem" : "1.3rem",letterSpacing:".06em",color:C.white,lineHeight:1,wordBreak:"break-word"}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap: isMobile ? 12 : 16}}>
          {[
            ["Nombre completo", `${adminInfo.nombre} ${adminInfo.apellido}`],
            ["Usuario", adminInfo.usuario],
            ["Correo electrónico", adminInfo.email],
            ["Rol", adminInfo.rol],
          ].map(([label, value]) => (
