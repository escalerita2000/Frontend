...
const RecoverPassword = () => {
  return (
    ...
    <canvas id="forgot-canvas"></canvas>
    ...
    <div className="forgot-card">
      ...
      <p className="forgot-sub">Introduce tu dirección de correo electrónico</p>
      <div className="forgot-form">
        <div className="input-group">
          <input type="email" placeholder="Correo electronico" autocomplete="email"/>
        </div>
        <button className="btn-send" type="button">Enviar&nbsp;&nbsp;Codigo</button>
