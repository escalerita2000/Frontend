            ...
            <main>
                ...
                <div className="search-box">
                    ...
                    <div className="search-actions">
                        ...
                        <button className="btn-send-search" type="button" aria-label="Enviar" onClick={handleSend}>
                ...
                <div className="quick-questions">
                    ...
                    <button className="btn-quick" type="button" onClick={handleSend}>¿Que es el sena?</button>
                    <button className="btn-quick" type="button" onClick={handleSend}>¿cuando abren las inscripciones?</button>
                    <button className="btn-quick" type="button" onClick={handleSend}>¿Ubicacion de instalaciones?</button>
                </div>
            </main>
        </>
    )
